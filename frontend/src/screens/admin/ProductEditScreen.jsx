...
import { useUpdateProductMutation, useGetProductQuery,useUploadProductImageMutation } from '../../slices/productsApiSlice'
...
const ProductEditScreen = () => {
    ...
    const submitHandler = async (e) => {
        e.preventDefault()
        const result = await updateProduct({ _id: productId, name, price, image, brand, category, countInStock, description })
        if (result.error) {
